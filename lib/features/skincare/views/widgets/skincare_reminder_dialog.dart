...
class SkincareReminderDialog extends StatelessWidget {
  final SkincareRoutine routine;

  const SkincareReminderDialog({
    super.key,
  ...
  static Future<void> show(BuildContext context, SkincareRoutine routine) {
    return showDialog(
      ...
      builder: (context) => SkincareReminderDialog(routine: routine),
    );
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Daily reminders have been scheduled for "${routine.title}". We will remind you on time!',
