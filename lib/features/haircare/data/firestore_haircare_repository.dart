...
///
/// The routine catalog is static content, but the *active* routine comes
/// from the signed-in user's own profile (`users/{uid}`).
class FirestoreHaircareRepository implements HaircareRepository {
  ...
  Future<void> saveActiveRoutine(String routineId) async {
    await _settings.updateActiveRoutine('haircare', routineId);
  }
